...
import de.hshannover.f4.trust.visitmeta.gui.nodeinformation.panel.ExtendetNodeInformationFactory;
...
public class ConnectionTab extends JPanel {
	...
	private void initPanels() {
		...
		LayoutHelper.addComponent(0, 1, 1, 1, 1.0, 0.0, mLowerPanel, searchAndFilterPanel, LayoutHelper.mNullInsets);
		LayoutHelper.addComponent(0, 2, 1, 1, 1.0, 0.0, mLowerPanel, historyNavigationStrategyPanel,
				LayoutHelper.mNullInsets);
		LayoutHelper.addComponent(0, 3, 1, 1, 1.0, 1.0, mLowerPanel, mPanelXmlTree, LayoutHelper.mNullInsets);
	...
	public void showExtendetNodeInformation(GraphicWrapper selectedNode) {

		if (selectedNode == null) {
			resetExtendetNodeInformation();
			return;
		}
		...
		try{
			...
			buildExtendetNodeInformation(selectedNode);
	...
	private void resetExtendetNodeInformation() {
	...
	private void buildExtendetNodeInformation(GraphicWrapper selectedNode) throws IllegalArgumentException {
		ExtendetNodeInformationPanel nodeInformation = ExtendetNodeInformationFactory.create(selectedNode);

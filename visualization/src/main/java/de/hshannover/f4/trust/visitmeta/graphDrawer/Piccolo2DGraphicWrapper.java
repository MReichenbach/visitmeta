...
public class Piccolo2DGraphicWrapper implements GraphicWrapper {
	...
	private static final String IFMAP_TIMESTAMP_FRACTION_ATTR = "ifmap-timestamp-fraction";
	...
	public Object getData() {
		return mNode.getParent().getAttribute("data");
	}
	...
	public int getTimeStampFraction() {
		...
		if (rootElement.hasAttributes() && rootElement.hasAttribute(IFMAP_TIMESTAMP_FRACTION_ATTR)) {
			String timeStampFraction = rootElement.getAttribute(IFMAP_TIMESTAMP_FRACTION_ATTR);
